...
| 时间 | 消息 |
|-----| ----- |
| 8 月 20 日 | 赛道一、二、三、五截止日期推迟，点击[查看推迟后的时间](#5-评测赛程) <br>请关注 [关于比赛截止日期推迟及提交技术报告的说明](docs/08-20-submit-report.md) |
| 7 月 30 日 | [关于队伍重组功能限时上线的说明](docs/07-31-reorganize.md)  <br>[关于赛道三、赛道五第二阶段提交的说明](docs/07-31-phrase-2.md) |
...
| ~~8 月 25 日~~ <br>9 月 1 日（23点59分） | 平台测试集结果提交入口关闭 |
| 9 月 10 日 | 公布评测结果 |
